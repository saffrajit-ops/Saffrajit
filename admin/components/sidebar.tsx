...
import { Menu, X, LogOut, Home, Package, BookOpen, Tag, Settings, ShoppingCart, Users, Video, ChevronDown, ChevronRight, User, Building2, Mail, ChevronLeft, Image as ImageIcon } from "lucide-react"
...
export function Sidebar() {
  ...
  // Auto-expand Settings if on settings page and Orders if on orders page
  useEffect(() => {
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            {!isMinimized && (
              <div>
                <h1 className="text-xl font-bold text-sidebar-foreground">CanaGold</h1>
