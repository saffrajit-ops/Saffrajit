        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="relative w-full aspect-[16/6] bg-muted rounded-xl overflow-hidden shadow-xl">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent p-6 flex flex-col justify-end">
              <div className="flex justify-start items-end w-full"> {/* Changed to justify-start */}
                {/* Author Avatar and Category */}
                <div className="flex items-end gap-3">

                  <Badge className="text-sm font-medium bg-black/40 text-white hover:bg-black/60 backdrop-blur-sm">
                    {post.category || 'Uncategorized'}
                  </Badge>
                </div>
                {/* Removed Read Time Badge from here */}
              </div>
            </div>
          </div>
